...
func Test_should_create_new_record_if_the_key_is_not_duplicate_to_existing_ones(t *testing.T) {
	...
	goutil.SendWithTimeoutOrPanic[any](storageChan, storagerepository.GetOrCreateRecordMessage{Key: "aaa", Success: success}, defaultTimeout)
	factory.New_CaptureReset()

	goutil.SendWithTimeoutOrPanic[any](storageChan, storagerepository.GetOrCreateRecordMessage{Key: "bbb", Success: success}, defaultTimeout)
...
func Test_should_pass_context_that_would_be_cancelled_when_stops(t *testing.T) {
	...
	goutil.SendWithTimeoutOrPanic[any](storageChan, storagerepository.GetOrCreateRecordMessage{Key: "", Success: func(dbstorage.Record) {}}, defaultTimeout)
